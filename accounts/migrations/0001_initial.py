# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-01 10:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Um nome curto que será usado para identificá-lo de forma única na plataforma', max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+S', 32), 'informe um nome de usuário válidoeste valor deve conter apenas letras e números e os caracteres @/./+/-/_ .', 'invalid')], verbose_name='Apelido / Usuário')),
